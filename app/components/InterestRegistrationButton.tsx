...
export default function InterestRegistrationButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex items-center gap-2 bg-primary hover:bg-primary/90 text-background-dark px-6 py-2.5 rounded-lg text-sm font-bold transition-all shadow-lg shadow-primary/20 ${className}`}
    >
      <span>잔여호실 상담</span>
