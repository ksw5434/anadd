    ...
    <section className="py-16 bg-neutral-100 dark:bg-surface-dark border-t border-neutral-200 dark:border-white/5">
      <div className="max-w-[1280px] mx-auto px-6 text-center">
        ...
        <p className="text-neutral-600 dark:text-neutral-400 mb-8 max-w-xl mx-auto">
          프리미엄 라이프스타일의 시작. 자세한 분양 일정과 혜택을 안내해 드립니다.
        </p>
        <div className="flex flex-wrap justify-center gap-4">
          <button className="bg-primary hover:bg-[#d9a60e] text-background-dark font-bold py-3 px-8 rounded-lg shadow-lg shadow-primary/20 transition-all transform hover:-translate-y-0.5">
            관심고객 등록하기
          </button>
