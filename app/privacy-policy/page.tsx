          ...
          <div className="prose prose-invert max-w-none text-neutral-300 space-y-6">
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>홈페이지 회원 가입 및 관리:</strong> 회원 가입의사
                  확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격
                  유지·관리, 서비스 부정이용 방지, 각종 고지·통지 목적
                </li>
                <li>
                  <strong>재화 또는 서비스 제공:</strong> 서비스 제공, 청약 및
                  분양 정보 제공, 계약서·청약서 등 발송, 콘텐츠 제공, 맞춤
                  서비스 제공
                </li>
                <li>
                  <strong>마케팅 및 광고에의 활용:</strong> 신규 서비스 개발 및
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  (다만, 관계 법령 위반에 따른 수사·조사 등이 진행중인 경우에는
                  해당 수사·조사 종료 시까지)
                </li>
                <li>
                  <strong>재화 또는 서비스 제공:</strong> 재화·서비스 공급완료
                  및 요금결제·정산 완료 시까지 (다만, 전자상거래법 등 관련
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>필수항목:</strong> 이름, 연락처(전화번호, 이메일),
                  주소
                </li>
                <li>
                  <strong>선택항목:</strong> 관심 분양 정보, 문의 사항
                </li>
                <li>
                  <strong>자동 수집 항목:</strong> IP주소, 쿠키, MAC주소, 서비스
                  이용 기록, 방문 기록, 불량 이용 기록 등
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>위탁받는 자(수탁자):</strong> [위탁업체명]
                </li>
                <li>
                  <strong>위탁하는 업무의 내용:</strong> [위탁업무 내용]
                </li>
              </ul>
              <p>
